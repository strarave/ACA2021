		...
		\section{Dynamic Scheduling}
			...
			\subsection{Scoreboard - Dynamic Scheduler Implementation}
				...
				\begin{enumerate}
 				...
 				\end{enumerate}
 				Ultimately, the Scoreboarding approach removes RAW hazards, by \emph{issuing an operation only when its operands are available}. WAW and WAR hazards are still to be taken care of.
